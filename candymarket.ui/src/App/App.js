...
const PublicRoute = ({ component: Component, authed, ...rest }) => {
  ...
  const routeChecker = props => (authed === false ? <Component {...props} {...rest}/> : <Redirect to={{ pathname: '/candyList', state: { from: props.location } }} />);
      ...
      <div className="App">
        <Router>
            <Switch>
              ...
              <PrivateRoute path="/" exact component={CandyList} authed={authed} testText={testText}/>
            </Switch>
        </Router>
      </div>
    );
